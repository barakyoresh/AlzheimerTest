 ...
 */
public class OptionDetailActivity extends Activity {
    private AlzTestUserPrefs currentUserPrefs = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.v(OptionListActivity.APPTAG, "Option Detail Activity");
