...
class CEmit
{
  ...
  **************************************************************/
     ...
     )
  {
    ...
    for (i = 0; i < m_spec.m_row_map.length; ++i)
	  {
	    ...
	    if (null == accept)
      {
        Log.v(OptionListActivity.APPTAG, " [nonaccepting]");
      }
	    else
      {
        Log.v(OptionListActivity.APPTAG, " [accepting, line "
	    ...
	    for (j = 1; j < m_spec.m_dtrans_ncols; ++j)
      {
        ...
        else
        {
          state = next;
	  	    if (tr)
		      {
            Log.v(OptionListActivity.APPTAG, "]");
            tr = false;
		      }
          if (CDTrans.F != state)
		      {
    ...
    Log.v(OptionListActivity.APPTAG, "---------------------- Transition Table "
                       + "----------------------");
  }
  ...
  **************************************************************/
  private void emit_driver
    ...
    m_outstream.println("\t\tboolean yy_initial = true;");
	  ...
	  if (NOT_EDBG)
    {
      m_outstream.println("\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"Begin\");");
    }
	  ...
	  if (NOT_EDBG)
    {
      m_outstream.println("java.lang.Log.v(OptionListActivity.APPTAG, \"Current state: \""
                          + " + yy_state");
	  ...
	  if (NOT_EDBG)
    {
      m_outstream.println("\t\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"State = \""
                          + "+ yy_state);");
      m_outstream.println("\t\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"Accepting status = \""
                          + "+ yy_this_accept);");
      m_outstream.println("\t\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"Last accepting state = \""
                          + "+ yy_last_accept_state);");
      m_outstream.println("\t\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"Next state = \""
                          + "+ yy_next_state);");
      m_outstream.println("\t\t\tjava.lang.Log.v(OptionListActivity.APPTAG, \"Lookahead input = \""
                          + "+ ((char) yy_lookahead));");
    }
  ...
  **************************************************************/
  void thompson
	  ...
	  if (CUtility.DO_DEBUG)
    {
	  ...
	  if (m_spec.m_verbose)
    {
      Log.v(OptionListActivity.APPTAG, "NFA comprised of "
...
class CSimplifyNfa
{
  ...
  private void computeClasses(CSpec m_spec) {
    ...
    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "NFA has "+nextcls+" distinct character classes.");
...
class CMinimize
{
  ...
  **************************************************************/
     ...
     )
  {
    ...
    if (CUtility.DEBUG)
	  {
	    /*Log.v(OptionListActivity.APPTAG, "k = " + k + "\nreduced_nrows = " + reduced_nrows + "");*/
  ...
  **************************************************************/
     ...
     )
  {
    ...
    Log.v(OptionListActivity.APPTAG, m_group.size() + " states after removal of redundant states.");

    if (m_spec.m_verbose
        && true == CUtility.OLD_DUMP_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, );
	    Log.v(OptionListActivity.APPTAG, "States grouped as follows after minimization");
	    pgroups();
	  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    if (m_spec.m_verbose
        && true == CUtility.OLD_DUMP_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, "Initial grouping:");
	    pgroups();
	    Log.v(OptionListActivity.APPTAG, );
	  }
  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    for (i = 0; i < dtrans_size; ++i)
	  {
	    Log.v(OptionListActivity.APPTAG, "\tstate " + i
                         + " is in group " 
                         + m_ingroup[i]);
	  }
  }
...
class CNfa2Dfa
{
  ...
  **************************************************************/
     ...
     )
  {
    ...
    if (m_spec.m_verbose && true == CUtility.OLD_DUMP_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, m_spec.m_dfa_states.size()
     ...
     )
  {
    ...
    while (false == nfa_stack.empty())
	    ...
	    if (CUtility.OLD_DUMP_DEBUG)
      {
        ...
        {
          Log.v(OptionListActivity.APPTAG, "Looking at accepting state " + state.m_label
                             + " with <"
          ...
          && state.m_label < bunch.m_accept_index)
      {
        ...
        if (CUtility.OLD_DUMP_DEBUG)
        {
          Log.v(OptionListActivity.APPTAG, "Found accepting state " + state.m_label
                             + " with <"
                             + (new String(state.m_accept.m_action,0,
                                           state.m_accept.m_action_read))
                             + ">");
     ...
     )
  {
    ...
    for (index = 0; index < size; ++index)
              ...
              && true == state.m_set.contains(b)))
      {
        ...
        bunch.m_nfa_set.addElement(state.m_next);
        /*Log.v(OptionListActivity.APPTAG, "Size of bitset: " + bunch.m_nfa_bit.size());
          Log.v(OptionListActivity.APPTAG, "Reference index: " + state.m_next.m_label);
          System.out.flush();*/
        bunch.m_nfa_bit.set(state.m_next.m_label);
      }
	  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    if (null != dfa)
	  {
	    if (CUtility.OLD_DUMP_DEBUG)
      {
        Log.v(OptionListActivity.APPTAG, " FOUND!");
      }
    ...
    if (CUtility.OLD_DUMP_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, " NOT FOUND!");
	  }
...
public class Main
{
  ...
  **************************************************************/
    ...
    throws java.io.IOException
  {
    ...
    if (arg.length < 1)
	  {
	    Log.v(OptionListActivity.APPTAG, "Usage: JLex.Main <filename>");
	    return;
	  }
    ...
    try 
	  ...
	  {
	    Log.v(OptionListActivity.APPTAG, e.getMessage());
	  }
  }
}    
...
class CUtility 
{
  ...
  *******************************************************/
  ...
  {
    Log.v(OptionListActivity.APPTAG, "Entering " + descent
                       + " [lexeme: " + lexeme 
                       + "] [token: " + token + "]");
  }
  ...
  *******************************************************/
  ...
  {
    Log.v(OptionListActivity.APPTAG, "Leaving " + descent
                       + " [lexeme:" + lexeme 
                       + "] [token:" + token + "]");
  }
  ...
  *******************************************************/
     ...
     )
  {
    if (DEBUG && false == expr)
	  {
	    Log.v(OptionListActivity.APPTAG, "Assertion Failed");
  ...
  *******************************************************/
     ...
     )
  {
    ...
    for (elem = 0; elem < n; ++elem)
      ...
      {
        /*Log.v(OptionListActivity.APPTAG, "return 0");*/
        return 0;
      }
	    if (a[a_first + elem] < b[b_first + elem])
      {
        /*Log.v(OptionListActivity.APPTAG, "return 1");*/
        return 1;
      }
...
class CError 
{
  ...
  *******************************************************/
  ...
  {
    Log.v(OptionListActivity.APPTAG, "JLex Error: " + message);
  }
  ...
  *******************************************************/
  ...
  {
    Log.v(OptionListActivity.APPTAG, "Error: Parse error at line "
                       + line_number + ".");
    Log.v(OptionListActivity.APPTAG, "Description: " + errmsg[error_code]);
...
class CLexGen 
{
  ...
  **************************************************************/
    ...
    throws java.io.FileNotFoundException, java.io.IOException
  {
    ...
    if (null == m_instream)
	  {
	    Log.v(OptionListActivity.APPTAG, "Error: Unable to open input file "
                         + filename + ".");
	    return;
	  }
    ...
    if (null == m_outstream)
	  {
	    Log.v(OptionListActivity.APPTAG, "Error: Unable to open output file "
                         + filename + ".java.");
	    return;
	  }
  ...
  **************************************************************/
    ...
    throws java.io.IOException, java.io.FileNotFoundException
  {
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Processing first section -- user code.");
	  }
    userCode();
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Processing second section -- "
                         + "JLex declarations.");
	  }
    userDeclare();
    if (m_input.m_eof_reached)
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Processing third section -- lexical rules.");
	  }
    userRules();
    if (CUtility.DO_DEBUG)
	  {
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Outputting lexical analyzer code.");
	  }
  ...
  **************************************************************/
  private void userDeclare
	  ...
	  while (false == m_input.getLine())
    {
      ...
      if (CUtility.OLD_DEBUG)
      {
        Log.v(OptionListActivity.APPTAG, "Line number "
                           + m_input.m_line_number + ":"); 
  ...
  **************************************************************/
    ...
    throws java.io.IOException
  {
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Creating NFA machine representation.");
	  }
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Creating DFA transition table.");
	  }
    ...
    if (m_spec.m_verbose)
	  {
	    Log.v(OptionListActivity.APPTAG, "Minimizing DFA transition table.");
	  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    Log.v(OptionListActivity.APPTAG, "--------------------- NFA -----------------------");
    ...
    while (states.hasMoreElements())
	    ...
	    if (CUtility.DEBUG)
      {
	    ...
	    Log.v(OptionListActivity.APPTAG, "State \"" + state
    ...
    throws java.io.IOException
  {
    ...
    if ('<' == m_input.m_line[m_input.m_line_index])
	    ...
	    while (true)
      {
        ...
        {
          /* Uninitialized state. */
          Log.v(OptionListActivity.APPTAG, "Uninitialized State Name: " + name);
  ...
  *******************************************************/
     ...
     )
  {
    ...
    if (null == def)
	  {
	    ...
	    Log.v(OptionListActivity.APPTAG, "Error: Undefined macro \"" + name + "\".");
	    CError.parse_error(CError.E_NOMAC, m_input.m_line_number);
	    return ERROR;
	  }
    if (CUtility.OLD_DUMP_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, "expanded escape: " + def);
	  }
    ...
    if (CUtility.OLD_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, new String(m_input.m_line,0,m_input.m_line_read));
	  }
    return NOT_ERROR;
  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    if (CUtility.OLD_DEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, "macro name \""
                         + new String(m_input.m_line,start_name,count_name)
                         + "\".");
	    Log.v(OptionListActivity.APPTAG, "macro definition \""
    ...
    while (m_input.m_line_index < m_input.m_line_read)
	  {
	    if (CUtility.OLD_DEBUG)
      {
        Log.v(OptionListActivity.APPTAG, "line read " + m_input.m_line_read
             ...
             && ',' != m_input.m_line[m_input.m_line_index])
      {
	    ...
	    if (CUtility.OLD_DEBUG)
      {
        Log.v(OptionListActivity.APPTAG, "State name \""
                           + new String(m_input.m_line,start_state,count_state)
                           + "\".");
        Log.v(OptionListActivity.APPTAG, "Integer index \""
    ...
    if (CUtility.DESCENT_DEBUG)
	  {
	    ...
	    Log.v(OptionListActivity.APPTAG, new String(accept.m_action,0,accept.m_action_read));
	  }
  ...
  *******************************************************/
    ...
    throws java.io.IOException
  {
    ...
    /*if (m_input.m_line_index > m_input.m_line_read) {
      Log.v(OptionListActivity.APPTAG, "m_input.m_line_index = " + m_input.m_line_index);
      Log.v(OptionListActivity.APPTAG, "m_input.m_line_read = " + m_input.m_line_read);
      CUtility.assert(m_input.m_line_index <= m_input.m_line_read);
      }*/
    ...
    if (CUtility.FOODEBUG)
	  {
	    Log.v(OptionListActivity.APPTAG, "Lexeme: " + m_spec.m_lexeme
  ...
  **************************************************************/
     ...
     )
  {
    ...
    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** Macros **");
    ...
    while (names.hasMoreElements())
	    ...
	    if (CUtility.DEBUG)
      {
	    ...
	    Log.v(OptionListActivity.APPTAG, "Macro name \"" + name
                         + "\" has definition \"" 
                         + def + "\".");
	  }

    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** States **");
    states = m_spec.m_states.keys();
    while (states.hasMoreElements())
	  {
	    state = (String) states.nextElement();
    ...
    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** Character Counting **");
    if (false == m_spec.m_count_chars)
	  {
	    Log.v(OptionListActivity.APPTAG, "Character counting is off.");
	  }
    else
	  {
	    if (CUtility.DEBUG)
      {
	    ...
	    Log.v(OptionListActivity.APPTAG, "Character counting is on.");
	  }

    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** Line Counting **");
    if (false == m_spec.m_count_lines)
	  {
	    Log.v(OptionListActivity.APPTAG, "Line counting is off.");
	  }
    else
	  {
	    if (CUtility.DEBUG)
      {
	    ...
	    Log.v(OptionListActivity.APPTAG, "Line counting is on.");
	  }

    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** Operating System Specificity **");
    if (false == m_spec.m_unix)
	  {
	    Log.v(OptionListActivity.APPTAG, "Not generating UNIX-specific code.");
	    Log.v(OptionListActivity.APPTAG, "(This means that \"\\r\\n\" is a "
                         + "newline, rather than \"\\n\".)");
	  }
    else
	  {
	    Log.v(OptionListActivity.APPTAG, "Generating UNIX-specific code.");
	    Log.v(OptionListActivity.APPTAG, "(This means that \"\\n\" is a "
                         + "newline, rather than \"\\r\\n\".)");
	  }

    Log.v(OptionListActivity.APPTAG, );
    Log.v(OptionListActivity.APPTAG, "\t** Java CUP Compatibility **");
    if (false == m_spec.m_cup_compatible)
	  {
	    Log.v(OptionListActivity.APPTAG, "Generating CUP compatible code.");
	    Log.v(OptionListActivity.APPTAG, "(Scanner implements "
                         + "java_cup.runtime.Scanner.)");
	  }
    else
	  {
	    Log.v(OptionListActivity.APPTAG, "Not generating CUP compatible code.");
	  }
    ...
    if (CUtility.FOODEBUG) {
      if (null != m_spec.m_nfa_states && null != m_spec.m_nfa_start)
	    {
	      Log.v(OptionListActivity.APPTAG, );
	      Log.v(OptionListActivity.APPTAG, "\t** NFA machine **");
	      print_nfa();
      }
    }
    ...
    if (null != m_spec.m_dtrans_vector)
	  {
	    Log.v(OptionListActivity.APPTAG, );
	    Log.v(OptionListActivity.APPTAG, "\t** DFA transition table **");
	    /*print_header();*/
	  }
    ...
    /*if (null != m_spec.m_accept_vector && null != m_spec.m_anchor_array)
      {
	    Log.v(OptionListActivity.APPTAG, );
	    Log.v(OptionListActivity.APPTAG, "\t** Accept States and Anchor Vector **");
	    print_accept();
      }*/
  }
  ...
  **************************************************************/
     ...
     )
  {
    ...
    Log.v(OptionListActivity.APPTAG, "/*---------------------- DFA -----------------------");
    ...
    while (states.hasMoreElements())
	    ...
	    if (CUtility.DEBUG)
      {
	    ...
	    if (CDTrans.F != m_spec.m_state_dtrans[i])
      {
        Log.v(OptionListActivity.APPTAG, "\tStart index in transition table: "
                           + m_spec.m_state_dtrans[i]);
      }
	    else
      {
        Log.v(OptionListActivity.APPTAG, "\tNo associated transition states.");
      }
	  }
...
final class SparseBitSet implements Cloneable {
  ...
  public static void main(String[] args) {
    ...
    Log.v(OptionListActivity.APPTAG, "Success.");
  }
}
